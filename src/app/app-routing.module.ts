...
const routes: Routes = [
  ...
  { path: "cardCreate", component: CardInitComponent, ...canActivate(redirectUnauthorizedToLogin) },
  { path: "cardView/:cardId", component: CardViewComponent },
  { path: "card/edit/:cardId", component: CreateCardComponent, ...canActivate(redirectUnauthorizedToLogin) },
  { path: "card/edit", component: CreateCardComponent, ...canActivate(redirectUnauthorizedToLogin) },
  { path: "savedCards/:userId", component: SavedcardsComponent, ...canActivate(redirectUnauthorizedToLogin) },
