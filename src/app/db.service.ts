...
export class dbService {
  ...
  searchCards(searchTerm: string) {
    return this.firestore
      .collection('userbasicDetails', (ref) =>
        ref.where('search', 'array-contains', searchTerm)
      )
      .valueChanges();
  }
  ...
  updateCardStatus(userId: string) {
    return this.firestore
      .collection('userbasicDetails')
      .doc(userId)
      .set({ cardCreated: true }, { merge: true });
  }
  ...
  feedback(feedbackObj: any) {
    return this.firestore
      .collection('feedbacks')
      .doc(feedbackObj.userId)
      .set(feedbackObj);
  }
